...
## Corpus Check
- 439 files · ~51,013,176 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2720 nodes · 3212 edges · 136 communities (125 shown, 11 thin omitted)
...
Cohesion: 0.09
Nodes (33): render_agent_details(), export_docx(), export_pdf(), export_report(), extract_audit_findings_matrix(), extract_canonical_control_id(), extract_target_entity_name(), find_latest_report() (+25 more)
